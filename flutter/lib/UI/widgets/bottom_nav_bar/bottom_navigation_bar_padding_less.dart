...
class BottomNavigationBarPaddingLess extends StatefulWidget {
  BottomNavigationBarPaddingLess({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
  ...
  @override
  _BottomNavigationBarStatePaddingLess createState() => _BottomNavigationBarStatePaddingLess();
}
...
class _BottomNavigationBarStatePaddingLess extends State<BottomNavigationBarPaddingLess> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(BottomNavigationBarPaddingLess oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final double additionalBottomPadding = 0; // math.max(widget.selectedFontSize / 2.0, 0.0);
...
class _Circle {
  ...
  final _BottomNavigationBarStatePaddingLess state;
  final int index;
  final Color color;
